      ...
      <nav class="navbar navbar-inverse">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="sidebar-menu">
			 ...
			 <li class="treeview">
                <a href="ApproveCng.jsp" target="_main">
                <i class="fa fa-laptop"></i>
                <span> APPROVE CNG PUMPS &nbsp;</span>
              
              <li class="treeview">
                <a href="ViewCng.jsp" target="_main">
                <i class="fa fa-laptop"></i>
               ...
               <li class="treeview">
                <a href="DeleteCng.jsp" target="_main">
                <i class="fa fa-laptop"></i>
				...
				<div class="forms">
					...
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						<div class="form-title">
							<h4><center> -: &nbsp; APPROVED CNG PUMPS FROM BELOW &nbsp;:- </center></h4>
						</div>
						<div class="form-body">
 								 ...
 								 <thead class="thead-dark">		 
		    						<tr>
								 	...
								 	<% 
										...
										PreparedStatement ps1=con.prepareStatement("select * from pumps1 where status=?");
										ps1.setString(1, sts);
